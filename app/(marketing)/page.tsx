    ...
    <div className="flex items-center justify-center flex-col">
      ...
      >
        <div
         ...
         text-amber-700 rounded-full upercase"
        >
      ...
      >
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod enim quis
        molestiae reprehenderit nemo soluta ex, veritatis nostrum, ut maiores
        saepe ea magnam velit cupiditate .
      </div>
